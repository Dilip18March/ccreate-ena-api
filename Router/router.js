...
router.get("/delete", auth.verifyToken, userController.delete);


router.get("/block", auth.verifyToken, userController.block);

// router.get("/Map", auth.verifyToken, userController.Map);
